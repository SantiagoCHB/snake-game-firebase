...
function App() {
  ...
  async function guardarPuntuacion(score) {
    try {
      ...
      console.log("Puntuación guardada en Firebase:", score);
    } catch (error) {
  ...
  useEffect(() => {
    if (gameOver) {
      guardarPuntuacion(score); // 🔥 Guardar puntaje en Firebase cuando termina el juego
      return;
    }
    ...
    const interval = setInterval(() => {
      setSnake((prevSnake) => {
        ...
        if (
          ...
          // 🏆 Guarda el high score localmente
          if (score > highScore) {
